...
import com.cloudstorage.fx.controllers.dialogs.AddToFolderDialogController;
    ...
    private void handleShare(SharedFileInfo file) {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                getClass().getResource("/com/cloudstorage/fx/dialogs/ShareFileDialogEnhanced.fxml")
            );
    ...
    private void handleMoveToFolder(SharedFileInfo file) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                getClass().getResource("/com/cloudstorage/fx/dialogs/AddToFolderDialog.fxml")
            );
            ...
            controller.setOnSuccess(() -> {
                // Refresh the shared files list after moving
                loadSharedFiles();
            });
